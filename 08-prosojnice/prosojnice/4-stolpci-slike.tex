...
\begin{columns}[c]
 ...
 \begin{column}{0.45\textwidth}
	\begin{tikzpicture}
				 ...
				 \pause
				 \coordinate (T') at ({-\td},{\tt});
				 \draw[gray, thin] (T') node[left] {\scriptsize$m$} arc[start angle=60, end angle=-60, radius=2] node[right] {\scriptsize};
                 \pause
				 \coordinate (T'') at ({\td},{\tt});
				 \draw[gray, thin] (T'') node[right] {\scriptsize$n$} arc[start angle=120, end angle=240, radius=2] node[right] {\scriptsize};
                 \pause
